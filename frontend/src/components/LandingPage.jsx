        ...
        <>
            ...
            <div className='body'>
                <div className="container">
                    ...
                    <div className="text-section">
                        ...
                        <p>Create your vendor profile in just a few clicks. Whether you're a food stall owner, canteen operator, or local eatery, SmartDine makes going digital simple, fast, and accessible — no technical skills required.</p>
            ...
            <div className="menu-container1">
                <div className="menu-text1">
                    <h2>ADD YOUR MENU</h2>
                    <h3>Manage Your Menu Effortlessly</h3>
                    <p>Ditch the paper menus and go digital! Add, update, or remove items anytime using text or voice — even in your local language. SmartDine keeps your offerings fresh, accurate, and always visible to customers.</p>
                </div>
            ...
            <div className="qr-container">
                ...
                <div className="qr-text">
                    <h2>GET YOUR QR</h2>
                    <h3>Instant Access with a Scan</h3>
                    <p>SmartDine generates a personalized QR code for your restaurant. Display it at your counter or table, and let customers view your live menu instantly — no app, no hassle.</p>
                </div>
            </div>
