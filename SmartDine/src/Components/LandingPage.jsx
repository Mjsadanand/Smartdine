        ...
        <>
            ...
            <div className="contact-wrapper">
                ...
                <div className="info-section">
                    ...
                    <div className="info-block"><h4>RESTAURANT</h4><p>123 Anywhere St. Any City, ST 12345</p></div>
                </div>
            </div>
            <span className="footer-text">© 2023 SmartDine | Privacy Policy | Disclaimer</span>
        </>
    );
};
